...
public class WorkingHoursDto {
    ...
    public WorkingHoursDto(LocalTime startWorkingDays, LocalTime endWorkingDays, LocalTime startSaturday, LocalTime endSaturday, LocalTime startSunday, LocalTime endSunday) {
